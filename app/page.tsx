              ...
              >
                ...
                <div className="flex flex-col gap-4 z-10">
                  ...
                  <div>
                    ...
                    <p className="text-[#4d6599] text-sm font-normal leading-normal">
                      Cargar facturas de proveedores para deducir impuestos (Crédito
                      Fiscal).
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-blue-700 mt-1">
                      Tienes {formatCRC(summary.saldoAFavorAnterior)} de saldo a favor de
                      períodos anteriores que se aplicará automáticamente.
                    </p>
                  </div>
                </div>
              )}
                  ...
                  {summary.ivaPagarConSaldo > 0 && summary.saldoAFavorAnterior > 0 && (
                    <div className="text-white/80 text-xs z-10 flex items-center gap-1">
                      ...
                      <span>
                        Saldo aplicado:{' '}
                        {formatCRC(
                          Math.min(summary.saldoAFavorAnterior, summary.ivaPagar)
                        )}
                      </span>
                    </div>
                  )}
                ...
                <div className="bg-white rounded-xl border border-[#d0d7e7] shadow-sm p-12 flex flex-col items-center justify-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[#4d6599] text-sm">
                      Sube tus archivos XML de facturación electrónica para ver el
                      desglose de tu actividad mensual.
                    </p>
                  </div>
                </div>
              ) : (
